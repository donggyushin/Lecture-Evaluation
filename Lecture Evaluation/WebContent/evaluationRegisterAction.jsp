<%@ page language="java" contentType="text/html; charset=utf-8"
	...
	if(request.getParameter("lectureYear")!= null){
		...
		try{
			...
			System.out.println("강의 연도 데이터 오류발생");
		}
	}
	...
	if(lectureName == null ||professorName == null ||lectureYear == 0 ||semesterDivide == null ||lectureDivide == null ||
			evaluationTitle == null ||evaluationContent == null ||totalScore == null ||creditScore == null ||comfortableScore == null ||
					...
					|| professorName.equals("") || lectureName.equals("")){
		PrintWriter script = response.getWriter();
		script.println("<script>");
	...
	EvaluationDTO evaluation = new EvaluationDTO(0, userID, lectureName, professorName, lectureYear, semesterDivide, lectureDivide,
