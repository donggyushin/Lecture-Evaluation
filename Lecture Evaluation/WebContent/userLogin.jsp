...
<section class="container mt-3">
	 <form class="form-signin" style="max-width: 560px; margin: 0 auto;" method="post" action="./userLoginAction.jsp">
      <h1 class="h3 mb-3 font-weight-normal">Please sign in</h1>
      <input type="text" id="inputUserID" name="userID" class="form-control mb-3" placeholder="input ID..." required autofocus>
      <input type="password" id="inputUserPassword" name="userPassword" class="form-control" placeholder="input Password..." required>
